...
guarantee that `/home` will be accessible to nodes in other pools, see notes in
the below table.

| Flag               | Pool           | Notes                                                 |
| ------------------ | -------------- | ----------------------------------------------------- |
| `+ALLOW_MWT2=True` | MidWest Tier-2 | `/data` is hot-mounted through `autofs` when accessed |
